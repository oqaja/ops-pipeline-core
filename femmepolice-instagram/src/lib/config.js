...
const CONFIG = {
  ...
  IG_BUSINESS_ACCOUNT_ID: getSecret("FEMMEPOLICE_IG_BUSINESS_ACCOUNT_ID"),

  INSIGHTS_POST_SHEET_NAME: "Instagram Femmepolice",
  INSIGHTS_ACCOUNT_SHEET_NAME: "Instagram Femmepolice Account",
  COMMENT_ARCHIVE_SHEET_NAME: "Instagram Femmepolice Comments",
...
module.exports = {
  CONFIG,
  getSecret,
  getIgAccessToken: () => getSecret("FEMMEPOLICE_IG_ACCESS_TOKEN"),
