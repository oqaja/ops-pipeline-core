...
// Dipakai tab "* Account" (follower/subscriber harian IG/TikTok/YouTube). Sebelumnya
// pakai appendRow polos -> tiap re-run / retry / cron dobel nambah baris baru, jadi
// ada tanggal yang numpuk.
